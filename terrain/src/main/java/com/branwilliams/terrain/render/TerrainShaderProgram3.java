 ...
 */
public class TerrainShaderProgram3 extends ShaderProgram {

    private final Matrix4f worldMatrix = new Matrix4f();

    public TerrainShaderProgram3(EngineContext engineContext) throws ShaderInitializationException, ShaderUniformException {
        ...
        this.setFragmentShader(IOUtils.readFile(directory, "shaders/terrain/fragmentShader3.frag", null));
        this.link();

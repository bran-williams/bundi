...
public class Frustum {
     ...
     * */
    public boolean insideFrustumAABB(AABB3f aabb) {
        Vector3f aabbCenter = aabb.getCenter();
        return insideFrustumAABB(aabbCenter.x + aabb.getMinX(), aabbCenter.x + aabb.getMaxX(),
                aabbCenter.y + aabb.getMinY(), aabbCenter.y + aabb.getMaxY(),
                aabbCenter.z + aabb.getMinZ(), aabbCenter.z + aabb.getMaxZ());
    }

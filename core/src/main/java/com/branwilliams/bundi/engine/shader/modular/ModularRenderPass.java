...
public class ModularRenderPass extends RenderPass<RenderContext> implements IComponentMatcher {
    ...
    public void init(RenderContext renderContext, Engine engine, Window window) throws InitializationException {
        try {
            EnvironmentShaderModule environmentShaderModule = new EnvironmentShaderModule(environment, vertexFormat,
                    materialFormat, DEFAULT_MATERIAL_NAME);
            shaderProgram = new ModularShaderProgram(vertexFormat, materialFormat,

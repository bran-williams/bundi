package com.branwilliams.demo.template;
 ...
 */
public class TemplateRenderer <Context extends RenderContext> extends AbstractRenderer<Context> {

    private final Vector4f clearColor = new Vector4f(0F, 0.75F, 1F, 1F);

    public TemplateRenderer(Scene scene, RenderPipeline<Context> renderPipeline) {

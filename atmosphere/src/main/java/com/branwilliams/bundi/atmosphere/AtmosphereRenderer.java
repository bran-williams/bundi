 ...
 */
public class AtmosphereRenderer extends AbstractRenderer {

    public AtmosphereRenderer(Scene scene, RenderPipeline renderPipeline) {
        super("atmosphereRenderer", scene, renderPipeline);
    }

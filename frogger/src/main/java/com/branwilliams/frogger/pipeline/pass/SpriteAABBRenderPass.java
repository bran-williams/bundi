...
public class SpriteAABBRenderPass extends RenderPass<RenderContext> {
    ...
    public SpriteAABBRenderPass(Scene scene) {
        this(scene, Vector2f::new);
    }

    public SpriteAABBRenderPass(Scene scene, Supplier<Vector2f> focalPoint) {
        this.scene = scene;
